    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="{{ url('/ukt') }}" class="btn btn-warning"><i class="bx bx-x d-block d-sm-none"></i>
                    Kembali</a>
            </div>
        </div>
    </div>
@else
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Hapus Data Tarif UKT</h5>
                <button type="button" class="close rounded-pill" data-bs-dismiss="modal" aria-label="Close">
                    <i data-feather="x"></i>
                </button>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="confirmDelete" data-id="{{ $ukt->ukt_id }}"" class="btn btn-primary ms-1">
    ...
    <script>
        $(document).on('click', '#confirmDelete', function() {
            ...
            const deleteUrl = "{{ route('settings.delete', ':id') }}".replace(':id', uktId);
