...
<body>
    ...
    <div id="app">
        @include('layouts.mahasiswa_layouts.sidebar')
        <div id="main">
            @include('layouts.mahasiswa_layouts.header')
            @include('layouts.mahasiswa_layouts.breadcrumb')

            @yield('content')

            @include('layouts.mahasiswa_layouts.footer')
        </div>
    </div>
